...
while True:
    ...
    if len(lmList)!=0:
        ...
        if lenght0 < 20: # fingers[1]==1 and fingers[2]==1:
        ...
        if fingers[1] == 0 and fingers[2] == 0 and fingers[3] == 1 and fingers[4] == 1:
            ...
            lenght, img, lineInfo = detector.findDistance(8, 5, img)
            print("Clicking mode len lmark 8 and 5 = ", lenght)
        ...
        if fingers[1] == 1 and fingers[2] == 1:
            ...
            print("Mouse scrolling UP = ", lenght2)
        ...
        if fingers[1] == 0 and fingers[2] == 0:
            ...
            print("Mouse scrolling DOWN = ",lenght3)
