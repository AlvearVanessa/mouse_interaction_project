"""
Hand Tracing Module with Black Background - only Hand

Mon, 11/03/24 13:02H CET
@uthor: maalvear
Source:
...
This code made the skeleton over the hand in a webcam in real-time,
and show only the skeleton
"""
